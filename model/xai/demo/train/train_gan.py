"""DCGAN 학습 및 저장 / Usage: uv run python train/train_gan.py"""
import sys, os
...
for epoch in range(EPOCHS):
    ...
    gen_losses.append(g_sum / n)
    disc_losses.append(d_sum / n)
...
print('저장: models/generator.weights.h5 / discriminator.weights.h5')
